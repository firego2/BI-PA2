...
{
public:
    CSearch() : my_takie_raznye(_Comparator())
    {
    };
    CSearch(const _Comparator &_cmp) : my_takie_raznye(_cmp)
    {
    };
    ...
    set<int>  Search  ( const _Type & hayHeap ) const
    {
        ...
        {
            bool push = true;
            for(auto i = hayHeap.begin(); i != hayHeap.end(); i++)
            {
                auto temp = i;
                push = true;
                for(auto r : l.second)
...
private:
    list<pair<int, _Type>> data;
    _Comparator my_takie_raznye;
};
//-------------------------------------------------------------------------------------------------
#ifndef __PROGTEST__
